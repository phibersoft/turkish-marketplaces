...
export interface I_Integrations_Ideasoft_Product_Converted extends Pick<I_Integrations_Ideasoft_Product, "id" | "name" | "sku" | "status" | "price1" | "discount"> {
    images: string[];
}
...
export interface I_Integrations_Ideasoft_ApiRequest_Orders_Params extends Pick<I_Integrations_Ideasoft_ApiRequest_Products_Params, "page" | "limit" | "sinceId" | "ids" | "startDate" | "startUpdatedAt" | "endDate" | "endUpdatedAt"> {
    sort: "id" | "-id";
    transactionId: string;
    customerEmail: string;
    member: number;
