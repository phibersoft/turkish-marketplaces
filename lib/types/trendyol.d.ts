...
export declare type I_Integrations_Trendyol_Product_Requireds = Pick<I_Integrations_Trendyol_Product, "title" | "categoryId" | "stockCode" | "listPrice" | "salePrice" | "images" | "attributes">;
...
export interface I_Integrations_Trendyol_GetProductsItem extends I_Integrations_Trendyol_Product {
    approved: boolean;
    archived: boolean;
    batchRequestId: string;
    brand: string;
...
export declare type I_Integrations_Trendyol_Order_StatusTypes = "Created" | "Picking" | "Invoiced" | "Shipped" | "Cancelled" | "Delivered" | "UnDelivered" | "Returned" | "Repack" | "UnPacked" | "UnSupplied";
