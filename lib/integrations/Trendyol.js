...
var Trendyol = /** @class */ (function () {
    function Trendyol(apiKey, apiSecret, firmId) {
        ...
        this.apiWithSupplier = axios_1.default.create({
    ...
    Trendyol.prototype.getOrders = function (params) {
        ...
        return helpers_service_1.IntegrationHelpers.wrapper(function () {
            return _this.apiWithSupplier.get("/orders?".concat(helpers_service_1.IntegrationHelpers.objectToQuery(_params)));
        });
    };
    Trendyol.prototype.getProducts = function (params) {
        ...
        return helpers_service_1.IntegrationHelpers.wrapper(function () {
            return _this.apiWithSupplier.get("products?".concat(helpers_service_1.IntegrationHelpers.objectToQuery(defParams)));
        });
    };
